...
def compute_footprint_reachable(
    ...
    collision checks. Default 1 (5 cm at 0.05 m/px) closes 1-pixel
    scan artifacts so the rotated footprint can't leak through thin
    walls. Set to 0 if you need tight legit gaps (costs 10 cm per
    corridor otherwise).
    """

...
class MainWin(QMainWindow):
    ...
    def __init__(s):
        ...
        # Hard-coded for the horizontal-only build. Step 4 (Analysis) and
        # Step 5 (RII Vertical) widgets are hidden after construction and
        # their tabs removed from the right-hand view bar.
    ...
    def _build(s):
        ...
        # Horizontal-only build: hide Step 4 + Step 5 sections after they're
        # constructed. They still exist as widget instances so any signals
        # already wired into them are safe; they're just never displayed.
        section6.hide()
        section7.hide()
        ...
        s._group_boxes = [section1, section4, section5]
        ...
        if s._v3_mode:
            _tab_names = [PRIMARY_SELECTION_VIEW, "3D Viewer", "Reference Coverage", "Actual Coverage", "Compare", "Planner Path"]
        else:
            _tab_names = [PRIMARY_SELECTION_VIEW, "Traversable Ground", "3D Viewer", "Reference Coverage", "Actual Coverage", "Compare", "Planner Path"]
        _tab_tooltips = {
